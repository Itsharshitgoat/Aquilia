...
from modules.products.manifest import manifest as products_manifest
from modules.auth.manifest import manifest as auth_manifest
from modules.users.manifest import manifest as users_manifest
...
config.config_data["apps"]["products"] = {}
config.config_data["apps"]["auth"] = {}
config.config_data["apps"]["users"] = {}
...
server = AquiliaServer(
    manifests=[products_manifest, auth_manifest, users_manifest],
    config=config,
    mode=_registry_mode,
)
